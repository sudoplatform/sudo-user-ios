Pod::Spec.new do |spec|
  ...
  spec.dependency 'AWSCognitoIdentityProvider', '~> 2.23.5'
  spec.dependency 'AWSAppSync', '~> 3.1.17'
  spec.dependency 'AWSMobileClient', '~> 2.23.5'
  spec.dependency 'AWSCore', '~> 2.23.5'
  spec.dependency 'AWSS3', '~> 2.23.5'
end
