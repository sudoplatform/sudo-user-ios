...
public struct DeviceCheckClientConfigProvider: AWSAppSyncServiceConfigProvider {
    ...
    /// Initializes `DeviceCheckClientConfigProvider` with the API endpoint URL
    /// and AWS region type.
    ///
    /// - Parameters:
    ...
    public init(endpoint: URL, region: AWSRegionType) {
        ...
        self.region = region
        self.apiKey = ProcessInfo.processInfo.environment["ADMIN_API_KEY"]
    }
